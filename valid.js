...
const checkSubject = () => {
    let valid = false;
    const subb = subjEl.value.trim();
    if (!isRequired(subb)) {
        showError(subjEl, 'Subject cannot be blank.');
    } else {
        showSuccess(subjEl);
        valid = true;
    }
...
const  submiTT=()=>{
    ...
    let isFormValid = isNameValid &&
        isEmailValid && isSubjectValid && isBodyValid
